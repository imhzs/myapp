...
var TApplication = /** @class */ (function (_super) {
    ...
    Object.defineProperty(TApplication.prototype, "UserFace", {
        get: function () {
            if (__WEBPACK_IMPORTED_MODULE_2__UltraCreation_Core_TypeInfo__["a" /* TypeInfo */].Assigned(localStorage.getItem('imageface'))) {
    ...
    // 页面导航
    TApplication.prototype.NavGo = function (uri) {
        location.href = "/#/" + uri;
    };
